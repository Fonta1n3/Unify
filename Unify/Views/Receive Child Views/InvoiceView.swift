...
struct InvoiceView: View, DirectMessageEncrypting {
    ...
    var body: some View {
        Form() {
            ...
            if let originalPsbt = originalPsbt, let outputAmount = outputAmount, let outputAddress = outputAddress {
                CreateProposalView(additionalInputs: additionalInputs,
                                   originalPsbt: originalPsbt,
                                   ourKeypair: ourKeypair!,
                                   payeeNpub: peerNpub,
                                   additionalOutputAddress: outputAddress,
                                   additionalOutputAmount: outputAmount)
            }
